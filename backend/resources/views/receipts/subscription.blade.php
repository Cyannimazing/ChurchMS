...
<body>
    <div class="receipt-card">
        ...
        <div class="receipt-header">
            <h1 class="brand-name">{{ $brand ?? 'FAITHSEEKER' }}</h1>
        ...
        <div class="receipt-details">
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="detail-value">{{ $plan->PlanName ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td class="detail-label">Duration:</td>
                    <td class="detail-value">{{ $duration ?? 0 }} month(s)</td>
                </tr>
                <tr>
        ...
        <div class="receipt-footer">
            <p class="thank-you-message">Thank you for your subscription!</p>
