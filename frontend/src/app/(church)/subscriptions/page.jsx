...
const SubscriptionStatus = () => {
  ...
  // Inside your component, after fetching currentSub:
  ...
  const getWarningMessage = () => {
    ...
    // Handle less than 1 minute left case
  ...
  const fetchSubscription = async () => {
    try {
      ...
      console.log("Fetched subscription:", response.data); // <-- log here
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p>
                    ...
                    {currentSub.pending?.StartDate
                      ? new Date(currentSub.pending.StartDate).toLocaleString()
                      : "N/A"}
                  </p>
                </div>
                <Button
