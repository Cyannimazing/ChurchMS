...
const TestimonialsSection = () => {
  const testimonials = [
    {
      ...
      quote: 'FaithSeeker has transformed how we manage sacramental services. The online booking system and real-time scheduling have eliminated conflicts and saved us countless hours.',
      heading: 'Streamlined Scheduling Process',
    },
    {
      name: 'Maria Cruz',
      title: 'Church Administrator at Holy Cross Parish',
      quote: 'The role-based dashboard allows us to assign tasks efficiently and manage documents securely. It’s a game-changer for organizing baptisms and weddings seamlessly.',
      heading: 'Efficient Church Administration',
    },
    {
      name: 'Ana Reyes',
      title: 'Parishioner at Our Lady of Fatima Church',
      quote: 'Booking a sacramental service online with FaithSeeker is so convenient. I can upload documents and track my request without visiting the church, saving me time and effort.',
      heading: 'Convenient Online Booking',
    },
    {
      name: 'Bro. Luis Gomez',
      title: 'Church Staff at San Isidro Parish',
      quote: 'The automated notifications keep everyone informed about service updates. It’s made communication with parishioners smoother and reduced missed appointments.',
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <section className="py-12 bg-gray-50 w-full flex justify-center">
