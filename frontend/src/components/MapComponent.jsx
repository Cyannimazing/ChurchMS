            ...
            <Popup className="custom-popup" maxWidth={250}>
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  <button 
                    onClick={() => handleReceiveSacrament(church)}
                  ...
                  <button className="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors cursor-pointer">
                    View Church
                  </button>
                </div>
              </div>
